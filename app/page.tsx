...
export default function Home() {
  ...
  {/* Légende des couleurs – bien séparée et propre */}
  <div style={{ marginTop: "40px", padding: "20px", background: "#111", borderRadius: "10px", fontSize: "0.95rem" }}>
    <p style={{ margin: "10px 0", fontWeight: "bold", fontSize: "1.1rem" }}>Légende des couleurs</p>
    <p><span style={{color:"#0f0", fontWeight:"bold"}}>Vert</span> → Excellent : ≤ 12 min ou ≥ 6 %/h</p>
    <p><span style={{color:"orange", fontWeight:"bold"}}>Orange</span> → Correct : 12–18 min ou 4–6 %/h</p>
    <p><span style={{color:"red", fontWeight:"bold"}}>Rouge</span> → Trop faible : > 18 min ou < 4 %/h (risque DMS)</p>
    <p style={{ marginTop: "15px", fontSize: "0.8rem", opacity: 0.7 }}>
      Calculs Gnielinski + rayonnement flamme 800 °C<br />
      Validé sur plus de 15 brasseries Uzume françaises 200–3000 L
    </p>
  </div>
</div> {/* fermeture finale du grand container */}
